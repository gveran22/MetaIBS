...
knitr::opts_chunk$set(fig.width = 15, fig.height = 5, warning=FALSE, message=FALSE,
                      root.dir = "/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/")
```
...
# Import metadata
metadata_table <- read.csv("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/Nagel_metadata.csv")
table(metadata_table$host_disease) # look at number of IBS vs HC
metadata_table$host_disease <- as.character(metadata_table$host_disease)
metadata_table[metadata_table[, 'host_disease'] == "healthy", 'host_disease'] <- 'Healthy'
metadata_table$author <- "Nagel"
metadata_table$sequencing_tech <- "Ion Torrent"
metadata_table$variable_region <- "V4"
rownames(metadata_table) <- metadata_table$Run
saveRDS(metadata_table, "/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/metadata_final.rds")

# Import OTU table (rows: sample names // columns: sequence variants)
seqtable.nochim <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/ASVtable_final.rds")
dim(seqtable.nochim) # should have 30 samples and 1081 ASV

# Import Taxonomic table (rows: sequence variants // columns: Kingdom, Phylum, Class, ...)
taxa <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/taxa_final.rds")
dim(taxa)
table(taxa[taxa[,1] != 'Archaea',2])
table(taxa[,2])
table(taxa[taxa[,1] != 'Archaea',3])
```


```{r demographics-stats, eval = FALSE, echo=FALSE}
# Age
...
test <- data.frame("Female" = c(12,10),
                      "Male" = c(3,5))
...
physeq <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/Rproject_DataAnalysis/physeq.rds")
physeq.rel <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/Rproject_DataAnalysis/physeq_relative.rds")
physeq.clr <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/Rproject_DataAnalysis/physeq_clr.rds")
metadata_table <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/metadata_final.rds")

saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/Rproject_DataAnalysis/physeq.rds")
# Distance methods
...
# Save physeq object
saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Nagel_2016/Rproject_DataAnalysis/physeq.rds")
saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Rproject_COMBINE/physeq_nagel.rds")
```

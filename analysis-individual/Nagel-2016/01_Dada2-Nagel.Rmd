...
raw_stats <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Nagel-2016/01_Dada2-Nagel/raw_stats.rds")
# out process
...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_nagel.rds")
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_nagel.rds")
```
...
nb.reads <- data.frame("before" = fastqq(trim_samples)@nReads,
                       "after" = rowSums(seqtable.nochim),
                       "dataset" = "Nagel")
saveRDS(nb.reads, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/DADA2-FILT/seqdepth_nagel.rds")
```
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(raw_stats, file.path(path, "01_Dada2-Nagel/raw_stats.rds"))
saveRDS(out1, file.path(path, "01_Dada2-Nagel/out1.rds"))
saveRDS(out2, file.path(path, "01_Dada2-Nagel/out2.rds"))
saveRDS(err, file.path(path, "01_Dada2-Nagel/errorRates.rds"))
saveRDS(err_new, file.path(path, "01_Dada2-Nagel/errorRates_modif.rds"))
saveRDS(seq_infered, file.path(path, "01_Dada2-Nagel/seq_infered.rds"))

saveRDS(otu_table(physeq), file.path(path, "01_Dada2-Nagel/ASVtable_final.rds")) # ASV table
saveRDS(tax_table(physeq), file.path(path, "01_Dada2-Nagel/taxa_final.rds")) # taxa table
saveRDS(sample_data(physeq), file.path(path, "01_Dada2-Nagel/metadata_final.rds")) # metadata table

# Taxa & Phyloseq object
saveRDS(taxa, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_nagel.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_nagel.rds")
```

...
nb.reads <- data.frame("before" = raw_stats$reads,
                       ...
                       "dataset" = "Mars")
saveRDS(nb.reads, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/DADA2-FILT/seqdepth_mars.rds")
```
...
```{r, eval=FALSE}
# Save to disk
saveRDS(raw_stats, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Mars-2020/01_Dada2-Mars/raw_stats.rds")

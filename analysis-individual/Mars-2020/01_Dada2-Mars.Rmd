...
REV.orients <- allOrients(REV) # R786
...
# Import metadata
metadata_table <- read.table("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Mars-2020/MarsSraRunTable.txt", header = TRUE, sep = ",")
...
write.csv(sample_data(physeq), "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Mars-2020/01_Dada2-Mars/MarsMetadata.csv")

...
# Make metadata table
metadata_table <- data.frame('Run' = rownames(seqtable.nochim))
rownames(metadata_table) <- metadata_table$Run
metadata_table$author <- "Ringel-Kulka"
metadata_table$sequencing_tech <- "454 pyrosequencing"
metadata_table$variable_region <- "V1-V2"

saveRDS(metadata_table, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/metadata_final.rds")

#_________________________________________________________________________
# Import OTU table (rows: sample names // columns: sequence variants)
seqtable.nochim <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/ASVtable_final.rds")
dim(seqtable.nochim) # should have 76 samples and 1378 ASV
...
taxa <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/taxa_final.rds")
dim(taxa)

# Remove 2 unknown eukaryota
seqtable.nochim <- seqtable.nochim[ , !(colnames(seqtable.nochim) %in% rownames(taxa[taxa[, 'Kingdom'] == 'Eukaryota',])) ]
taxa <- taxa[taxa[, 'Kingdom'] != 'Eukaryota',]
```
XXXXXX

First, let's import the phyloseq object that was created at the end of the Dada2 pipeline.
```{r import-data}
...
physeq <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/OutputPhangorn/physeq_ringel.rds")
physeq.rel <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_relative.rds")
physeq.clr <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_clr.rds")
...
# Look at the tree
plot_tree(physeq, ladderize="left")
```
...
# Save physeq object
saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq.rds")
saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Rproject_COMBINE/physeq_ringel.rds")
```
...
```{r plot-abundances, fig.height = 6}
# Remove samples that have less than 500 total reads
...
```{r plot-log-ratio, fig.height = 3, fig.width=7, eval = FALSE, echo = FALSE}
...
physeq_best <- subset_taxa(physeq_best, !is.na(Phylum)) # remove the 13 NA Phyla
saveRDS(physeq_best, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_best.rds")
...
saveRDS(physeq.NZcomp, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_NZcomp.rds")
...
saveRDS(physeq.rel, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_relative.rds")
...
saveRDS(physeq.CSN, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_CSN.rds")
...
# save the physeq.rel object
saveRDS(physeq.clr, "/Users/scarcy/Desktop/Praktikum/Data/Ringel_Kulka_2015/Rproject_DataAnalysis/physeq_clr.rds")
```
...
plot.df$author <- "Ringel-Kulka"
plot.df$host_disease <- "Healthy"
...
p1 <- ggplot(plot.df[plot.df$distance == "Weighted Unifrac",], aes(Axis.1, Axis.2, color = host_disease))+
  ...
  theme(axis.title = element_blank(),
        ...
        strip.text.x = element_text(size = 70, margin = margin(1,0,1,0, "cm")),
...
p2 <- ggplot(plot.df[plot.df$distance != "Weighted Unifrac",], aes(Axis.1, Axis.2, color = host_disease))+
  ...
  theme(axis.text = element_text(size = 30),
        ...
        strip.background = element_rect(fill = "white",size = 3),
        panel.border = element_rect(size = 2),
        strip.text = element_text(size = 70, margin = margin(1,0,1,0, "cm")),
        #strip.text.x = element_blank(),
        #axis.line = element_line(size = 1, arrow = arrow(length = unit(0.1, "inches")))
        )
...
jpeg("/Users/scarcy/Desktop/Praktikum/Thesis/dist_Ringel.jpeg", height = 1000, width = 4000, res = 100)
...
Distances <- function(physeq_obj){
  ...
  dist.list <- list("UniF" = glom.UniF, "Ait" = glom.ait, "Canb" = glom.can, "Bray" = glom.bray, 'Gower' = glom.gower)
...
MDS_2D <- function(physeq_obj, ait_dist){
  ...
  for(i in dist_methods){
    ...
    p <- plot_ordination(physeq_obj, iMDS)
  ...
  # Plot
  p.alldist <-  ggplot(plot.df, aes(Axis.1, Axis.2))+
...
jpeg("./Plots/plot_allDistances_MDS.jpg", width = 2500, height = 2000, res = 90)
no_glom.2D.alldist +
...
jpeg("./Plots/plot_heatmap_bray.jpg", width = 1400, height = 1000, res = 200)

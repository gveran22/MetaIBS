...
raw_stats <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/LoPresti-2019/01_Dada2-LoPresti/raw_stats.rds")
# out process
...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_lopresti.rds")
#physeq
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_lopresti.rds")
```
...
# Import metadata
metadata_table <- read.csv("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/LoPresti-2019/LoPresti_SraRunTable.csv")
...
colnames(sampledf) <- c("Run", "host_disease", "sample_type", "host_age", "host_sex", "host_subtype", "host_ID", "collection_date")
sampledf$host_disease <- as.character(sampledf$host_disease)
sampledf$sample_type <- as.character(sampledf$sample_type)
sampledf$host_subtype <- as.character(sampledf$host_subtype)
...
sampledf$host_subtype[sampledf$host_subtype == "Absence"] <- "HC"
sampledf$host_subtype[sampledf$host_subtype == "Alternating constipation and diarrhea"] <- "IBS-M"
sampledf$host_subtype[sampledf$host_subtype == "diarrhea"] <- "IBS-D"
sampledf$host_subtype[sampledf$host_subtype == "constipation"] <- "IBS-C"
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(raw_stats, file.path(path, "01_Dada2-LoPresti/raw_stats.rds"))
saveRDS(out1, file.path(path, "01_Dada2-LoPresti/out1.rds"))
saveRDS(out2, file.path(path, "01_Dada2-LoPresti/out2.rds"))
saveRDS(err, file.path(path, "01_Dada2-LoPresti/err.rds"))
saveRDS(seq_infered, file.path(path, "01_Dada2-LoPresti/seq_infered.rds"))
saveRDS(seqtable.nochim, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/input/seqtable_lopresti.rds")

saveRDS(otu_table(physeq), file.path(path, "01_Dada2-LoPresti/ASVtable_final.rds")) # ASV table
saveRDS(tax_table(physeq), file.path(path, "01_Dada2-LoPresti/taxa_final.rds")) # taxa table
saveRDS(sample_data(physeq), file.path(path, "01_Dada2-LoPresti/metadata_final.rds")) # metadata table

# Taxa & Phyloseq object
saveRDS(taxa, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_lopresti.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_lopresti.rds")
```

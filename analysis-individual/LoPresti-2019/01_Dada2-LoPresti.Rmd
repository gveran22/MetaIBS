...
write.table(sample_data(physeq), file.path(path, "LoPrestiMetadata.csv"))

saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/phyloseq-objects/physeq_lopresti.rds") # phyloseq object
```

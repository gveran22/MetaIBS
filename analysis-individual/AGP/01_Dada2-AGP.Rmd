...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_agp.rds")
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_agp.rds")
```
...
saveRDS(nb.reads, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/DADA2-FILT/seqdepth_agp.rds")
```
...
# saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_agp.rds")
# saveRDS(sample_data(physeq), file.path(path, "01_Dada2-AGP/metadata_final.rds")) # metadata table
...
#___________________________
# OUTPUT (TO-DO)
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/output/physeq_agp.rds")
sample_data(physeq)
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/output/physeq_agp.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/phyloseq-objects/physeq_agp.rds")
```
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(raw_stats, file.path(path, "01_Dada2-AGP/raw_stats.rds"))
saveRDS(out2, file.path(path, "01_Dada2-AGP/out2.rds"))
saveRDS(err, file.path(path, "01_Dada2-AGP/err.rds"))
saveRDS(seq_infered, file.path(path, "01_Dada2-AGP/seq_infered.rds"))


saveRDS(otu_table(physeq), file.path(path, "01_Dada2-AGP/ASVtable_final.rds")) # ASV table
saveRDS(tax_table(physeq), file.path(path, "01_Dada2-AGP/taxa_final.rds")) # taxa table
saveRDS(sample_data(physeq), file.path(path, "01_Dada2-AGP/metadata_final.rds")) # metadata table

# Taxa & Phyloseq object
saveRDS(taxa, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_agp.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_agp.rds")
```

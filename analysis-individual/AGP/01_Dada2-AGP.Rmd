...
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/AGP/01_Dada2-AGP/physeq_agp_with_bloom.rds")
```
...
physeq.filt <- prune_samples(sample_sums(physeq.filt)>=500, physeq.filt) # 16,797 ASVs and 1,183 samples

...
# out process
out1 <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/out1.rds")
out2 <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/out2.rds")
raw_stats <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/raw_stats.rds")
# look at quality
...
# error rates
err <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/err.rds")
# infered sequences
seq_infered <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/seq_infered.rds")
# taxa
taxa <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/OutputTaxa/taxa_AGP.rds")
# phyloseq object
physeq <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/physeq_AGP.rds")
```
...
# Import metadata
metadata_table <- read.table("/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/AGPSraRunTable.txt", header = TRUE, sep = ",")
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(out1, "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/out1.rds")
saveRDS(out2, "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/out2.rds")
saveRDS(err, "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/err.rds")
saveRDS(seq_infered, "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/seq_infered.rds")


saveRDS(otu_table(physeq), "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/ASVtable_final.rds") # ASV table
saveRDS(tax_table(physeq), "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/taxa_final.rds") # taxa table
saveRDS(sample_data(physeq), "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/metadata_final.rds") # metadata table
write.csv(sample_data(physeq), "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/Rproject_Dada2/AGPMetadata.csv")

saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/AGP_2021/physeq_AGP.rds") # phyloseq object


# Save nb of reads per sample before / after dada2 pipeline
nb.reads <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/nb_reads.rds")
nb.reads[1:290, 'AGP_before'] <- fastqq(FNs)@nReads
nb.reads[1:290, 'AGP_after'] <- rowSums(seqtable.nochim)

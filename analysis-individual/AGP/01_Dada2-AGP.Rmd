...
write.csv(sample_data(physeq), file.path(path, "Metadata-AGP.csv"))

saveRDS(physeq, file.path(path, "01_Dada2-AGP/physeq_AGP.rds")) # phyloseq object
saveRDS(physeq.filt, file.path(path, "01_Dada2-AGP/physeq(ASVfilt)_AGP.rds"))
```

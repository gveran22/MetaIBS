...
# Plot Phylum
plot_bar(physeq.zhuang, fill = "Phylum") + facet_wrap("host_disease", scales="free_x") +
...
# Plot Class
plot_bar(physeq.zhuang, fill = "Class")+ facet_wrap("host_disease", scales="free_x") +
  theme(axis.text.x = element_text(size = 8))+
  labs(x = "Samples", y = "Absolute abundance", title = "Zhuang dataset (2018)")
```
...
wilcox.test(ratio.FB[ratio.FB$host_disease == "IBS","logRatioFB"],
            ratio.FB[ratio.FB$host_disease == "Healthy","logRatioFB"]) # p = 0.59
```

...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/OutputTaxa/taxa_zhuang.rds")
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/phyloseq-objects/physeq_zhuang.rds")
```
...
# Import metadata
metadata_table <- read.csv("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/ZhuangSraRunTable.csv", header = TRUE, sep = ",")
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(out2, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/out2.rds")
saveRDS(errF, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/errF.rds")
saveRDS(errR, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/errR.rds")
saveRDS(dadaFs, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/infered_seq_F.rds")
saveRDS(dadaRs, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/infered_seq_R.rds")
saveRDS(mergers, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/mergers.rds")

saveRDS(otu_table(physeq), "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/ASVtable_final.rds") # ASV table
saveRDS(tax_table(physeq), "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/taxa_final.rds") # taxa table
saveRDS(sample_data(physeq), "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/metadata_final.rds") # metadata table
write.csv(sample_data(physeq), "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zhuang-2018/01_Dada2-Zhuang/ZhuangMetadata.csv")

saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/phyloseq-objects/physeq_zhuang.rds") # phyloseq object



# Save nb of reads per sample before / after dada2 pipeline
nb.reads <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/nb_reads.rds")
nb.reads[1:30, 'Zhuang_before'] <- fastqq(fnFs)@nReads
nb.reads[1:30, 'Zhuang_after'] <- rowSums(seqtable.nochim)
median(na.omit(nb.reads$Zhuang_before)) # sanity check
median(na.omit(nb.reads$Zhuang_after)) # sanity check

...
```{r save, eval=FALSE}
# Save to disk
saveRDS(out1, file.path(path, "01_Dada2-Labus/out1.rds"))
saveRDS(out2, file.path(path, "01_Dada2-Labus/out2.rds"))
saveRDS(err, file.path(path, "01_Dada2-Labus/err.rds"))
saveRDS(seq_infered, file.path(path, "01_Dada2-Labus/seq_infered.rds"))

saveRDS(otu_table(physeq), file.path(path, "01_Dada2-Labus/ASVtable_final.rds")) # ASV table
saveRDS(tax_table(physeq), file.path(path, "01_Dada2-Labus/taxa_final.rds")) # taxa table
saveRDS(sample_data(physeq), file.path(path, "01_Dada2-Labus/metadata_final.rds")) # metadata table
write.csv(sample_data(physeq), file.path(path, "LabusMetadata.csv")) # metadata table

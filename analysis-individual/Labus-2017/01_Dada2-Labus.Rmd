...
raw_stats <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Labus-2017/01_Dada2-Labus/raw_stats.rds")
...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_labus.rds")
#physeq
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_labus.rds")
```
...
# Import metadata
metadata_table <- read.csv("~/Projects/IBS_Meta-analysis_16S/analysis-individual/Labus-2017/Metadata-Labus.csv")
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(raw_stats, file.path(path, "01_Dada2-Labus/raw_stats.rds"))
...
saveRDS(taxa, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_labus.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_labus.rds")
```

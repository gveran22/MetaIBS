...
Make heatmap with ASVs
```{r}
# For color
# matcol <- data.frame(group = sample_data(physeq.zhu)[,"host_disease"])
# 
# library(RColorBrewer)

# pheatmap(log10(t(as.matrix(otu_table(physeq.NZcomp)))),
...
ggsave("../../data/analysis-individual/PLOTS/plots-Zhu-EDA/heatmap_ASVs.jpg", height=6, width=8, dpi=300)
...
# Try again after aggregation
physeq.rel <- tax_glom(physeq.rel, taxrank="Family")
physeq.clr <- tax_glom(physeq.clr, taxrank="Family")
physeq.CSN <- tax_glom(physeq.CSN, taxrank="Family")
physeq.NZcomp <- tax_glom(physeq.NZcomp, taxrank="Family")

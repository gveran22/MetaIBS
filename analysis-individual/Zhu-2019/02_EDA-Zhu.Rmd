...
# Import metadata
metadata_table <- read.table("/Users/scarcy/Desktop/Praktikum/Data/Zhu_2019/ZhuSraRunTable.txt", header = TRUE, sep = ",")
...
colnames(metadata_table) <- c("Run", "host_age", "host_disease", "host_sex")
...
metadata_table$author <- "Zhu"
metadata_table$sequencing_tech <- "Illumina MiSeq"
metadata_table$variable_region <- "V4"

saveRDS(metadata_table, "/Users/scarcy/Desktop/Praktikum/Data/Zhu_2019/metadata_final.rds")

# Import OTU table (rows: sample names // columns: sequence variants)
seqtable.nochim <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zhu_2019/ASVtable_final.rds")
...
taxa <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zhu_2019/taxa_final.rds")
dim(taxa)

...
write.csv(sample_data(physeq), file.path(path, "PozueloMetadata.csv"))

saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/phyloseq-objects/physeq_pozuelo.rds") # phyloseq object
```

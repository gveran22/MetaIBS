...
plot_bar(physeq.fukui, fill = "Phylum") + facet_wrap("host_disease", scales="free") +
  ...
  labs(x = "Samples", y = "Absolute abundance", title = "fukui dataset (2018)")
...
ggplot(phylum.table, aes(x = Sample, y = Abundance, fill = Phylum))+
  ...
  labs(x = "Samples", y = "Relative abundance", title = "fukui dataset (2018)")
...
plot_bar(physeq.fukui, fill = "Phylum") + facet_wrap("host_disease", scales="free") +
  ...
  labs(x = "Samples", y = "Total read count", title = "fukui dataset (2018)")
dev.off()
...
ggplot(ratio.FB, aes(x = host_disease, y = logRatioFB))+
  ...
  labs(x = "",  y = 'Log2(Firmicutes/Bacteroidota)', title = "fukui dataset (2018)")+
  theme_classic()+

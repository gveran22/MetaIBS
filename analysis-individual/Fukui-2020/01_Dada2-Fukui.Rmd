...
# out process
FWD.out1 <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Fukui-2020/01_Dada2-Fukui/FWD_out1.rds")
REV.out1 <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Fukui-2020/01_Dada2-Fukui/REV_out1.rds")
out2 <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Fukui-2020/01_Dada2-Fukui/out2.rds")
track <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Fukui-2020/01_Dada2-Fukui/track.rds")
# primer removal
...
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/phyloseq-objects/physeq_fukui.rds")
```
...
saveRDS(seqtable.nochim, "~/Desktop/Cluster/Dada2/seqtable_fukui.rds")
```
...
metadata_table[grep("HC*",metadata_table$Sample.Name), "host_disease"] <- "HC"
# Sanity check
...
nb.reads[1:747, 'Fukui_before'] <- fastqq(fnFs)@nReads
nb.reads[1:744, 'Fukui_after'] <- rowSums(seqtable.nochim)

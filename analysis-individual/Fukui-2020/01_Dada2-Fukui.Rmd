...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_fukui.rds")
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_fukui.rds")
```
...
seqtable <- seqtable[,nchar(colnames(seqtable)) %in% 260:360]
dim(seqtable)
hist(nchar(getSequences(seqtable)), breaks = 100, xlab = "ASV length", ylab = "Number of ASVs", main="")
```
...
nb.reads <- data.frame("before" = raw_stats$reads,
                       ...
                       "dataset" = "Fukui")
saveRDS(nb.reads, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/DADA2-FILT/seqdepth_fukui.rds")
```

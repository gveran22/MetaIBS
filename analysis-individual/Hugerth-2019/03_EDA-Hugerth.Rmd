...
wilcox.test(metadata[metadata$host_disease == "IBS", ]$host_age,
            metadata[metadata$host_disease == "Healthy", ]$host_age) # p=0.21
...
```{r reproduce-fig4, eval = TRUE, echo = TRUE, fig.height = 6, fig.width = 10}
...
```{r reproduce-fig5, eval = TRUE, echo = TRUE, fig.height = 6, fig.width = 10}

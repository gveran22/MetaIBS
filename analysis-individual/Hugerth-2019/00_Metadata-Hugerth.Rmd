...
# What are those 7 Runs that don't match?
paperDF %>%
  filter(!Run %in% paperRuns.DF$Run)
# Interestingly, we find again the 4 samples that had no entry in the SRA metadata... And the other 3 samples are healthy
```

...
Now, if we were to consider other covariates as proxies for sample identifiers, we get much less inconsistencies in disease phenotype. We can use BMI, age and collection date as relevant information to identify samples belonging to the same individual. Then we have 1 

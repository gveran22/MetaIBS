...
# out process
raw_stats <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zeber-2016/01_Dada2-Zeber/raw_stats.rds")
...
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_zeber.rds")
# physeq
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_zeber.rds")
```
...
# Import metadata
metadata_table <- read.csv("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/Zeber-2016/ZeberSraRunTable.csv")

# Simplify data
rownames(metadata_table) <- metadata_table$Run # have the same sample.names
colnames(metadata_table) <- c("Run", "host_ID", "host_disease", "host_subtype", "host_sex")
...
metadata_table$host_ID <- gsub('\\:0$', '', metadata_table$host_ID)
...
# saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_zeber.rds")
...
# sample_data(physeq)[sample_data(physeq)$host_disease == "IBS", "host_subtype"] <- "IBS-unspecified"
# sample_data(physeq)$sequencing_tech <- "Illumina single-end"
colnames(sample_data(physeq))[2] <- "host_ID"
sample_data(physeq)$Collection <- "1st"

# sample_data(physeq)[sample_data(physeq)$host_disease == "None", "host_disease"] <- "Healthy"
# sample_data(physeq)$host_subtype <- "..."
# sample_data(physeq)$sample_type <- "stool"

#___________________________
# OUTPUT (TO-DO)
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/output/physeq_zeber.rds")
sample_data(physeq)
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/output/physeq_zeber.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/phyloseq-objects/physeq_zeber.rds")
```
...
saveRDS(taxa, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/Taxonomy/output/taxa_zeber.rds")
saveRDS(physeq, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_zeber.rds")
```

...
saveRDS(metadata_table, "/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/metadata_final.rds")

#____________________________________________________________________
# Import OTU table (rows: sample names // columns: sequence variants)
seqtable.nochim <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/ASVtable_final.rds")
dim(seqtable.nochim) # should have 90 samples and 14499 ASV
...
taxa <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/taxa_final.rds")
dim(taxa)

#____________________________________________________________________
# Remove OTUs with unknown kingdom or Eukaryota
seqtable.nochim <- seqtable.nochim[ , !(colnames(seqtable.nochim) %in% rownames(taxa[is.na(taxa[, 'Kingdom']),])) ]
seqtable.nochim <- seqtable.nochim[ , !(colnames(seqtable.nochim) %in% rownames(taxa[taxa[, 'Kingdom'] == 'Eukaryota',])) ]
taxa <- taxa[!is.na(taxa[, 'Kingdom']),] # remove NA kingdoms
taxa <- taxa[taxa[, 'Kingdom'] == 'Bacteria',] # keep only bacteria

dim(seqtable.nochim) # sanity check 14,474 OTUs
dim(taxa)
```
XXXXX
...
physeq <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/OutputPhangorn/physeq_zeber.rds")
physeq.rel <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq_relative.rds")
physeq.clr <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq_clr.rds")
metadata_table <- readRDS("/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/metadata_final.rds")
...
mat_col <- data.frame(group = metadata_table[,"host_disease"],
                      subtype = metadata_table[,"host_subtype"])
...
# Save physeq object
saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq.rds")
saveRDS(physeq, "/Users/scarcy/Desktop/Praktikum/Data/Rproject_COMBINE/physeq_zeber.rds")
```
...
plot_bar(physeq, fill = "Phylum") + facet_wrap("host_disease", scales="free") +
  ...
  labs(x = "Samples", y = "Total read count", title = "Zeber-Lubecka dataset (2016)")+
  ylim(0, 170000)
...
ggplot(ratio_FB, aes(x = host_disease, y = Log_ratio_FB))+
  ...
  labs(x = "",  y = 'Log2 Firmicutes/Bacteroidota Abundance Ratio', title = "Zeber-Lubecka dataset (2016)")+
  theme_classic()+
...
physeq_best <- subset_taxa(physeq_best, !is.na(Phylum)) # remove the 40 NA Phyla
physeq_best
...
saveRDS(physeq.NZcomp, "/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq_NZcomp.rds")
...
saveRDS(physeq.rel, "/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq_relative.rds")
...
saveRDS(physeq.CSN, "/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq_CSN.rds")
...
# save the physeq.rel object
saveRDS(physeq.clr, "/Users/scarcy/Desktop/Praktikum/Data/Zeber-Lubecka_2016/Rproject_DataAnalysis/physeq_clr.rds")
```
...
Distances <- function(){
  ...
  glom.UniF <- phyloseq::distance(physeq.rel, method = 'horn') # unifrac
...
jpeg("/Users/scarcy/Desktop/Praktikum/Thesis/dist_Zeber.jpeg", height = 850, width = 4000, res = 100)
...
jpeg("./Plots/AllDistances_MDS.jpg", width = 3000, height = 2000, res = 110)
no_glom.2D.alldist +

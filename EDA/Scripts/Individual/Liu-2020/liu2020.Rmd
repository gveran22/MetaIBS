...
path.liu  <- file.path(path.root, "Analysis/Scripts/Individual/Liu-2020")
path.data <- file.path(path.root, "data/phyloseq-objects")
path.plots <- file.path(path.root, "Analysis/Plots/Individual/Liu-2020")
```


## Read data
```{r read-data, echo=FALSE}
physeq <- readRDS(file.path(path.data, "physeq_liu.rds")) # phyloseq object
```

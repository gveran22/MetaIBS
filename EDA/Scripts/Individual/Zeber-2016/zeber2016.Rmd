...
path.zeber  <- file.path(path.root, "Analysis/Scripts/Individual/Zeber-2016")
path.data <- file.path(path.root, "data/phyloseq-objects")
path.plots <- file.path(path.root, "Analysis/Plots/Individual/Zeber-2016")
```


## Read data
```{r read-data, echo=FALSE}
physeq <- readRDS(file.path(path.data, "physeq_zeber.rds")) # phyloseq object
```

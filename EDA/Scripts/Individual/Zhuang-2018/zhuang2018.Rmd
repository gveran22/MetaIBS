...
path.zhuang  <- file.path(path.root, "Analysis/Scripts/Individual/Zhuang-2018")
path.data <- file.path(path.root, "data/phyloseq-objects")
path.plots <- file.path(path.root, "Analysis/Plots/Individual/Zhuang-2018")
```


## Read data
```{r read-data, echo=FALSE}
physeq <- readRDS(file.path(path.data, "physeq_zhuang.rds")) # phyloseq object
```

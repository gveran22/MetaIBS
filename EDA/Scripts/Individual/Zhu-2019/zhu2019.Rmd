...
path.zhu  <- file.path(path.root, "Analysis/Scripts/Individual/Zhu-2019")
path.data <- file.path(path.root, "data/phyloseq-objects")
path.plots <- file.path(path.root, "Analysis/Plots/Individual/Zhu-2019")
```


## Read data
```{r read-data, echo=FALSE}
physeq <- readRDS(file.path(path.data, "physeq_zhu.rds")) # phyloseq object
```

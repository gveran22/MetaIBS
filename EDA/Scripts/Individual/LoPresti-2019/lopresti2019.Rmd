...
path.lopresti  <- file.path(path.root, "Analysis/Scripts/Individual/LoPresti-2019")
path.data <- file.path(path.root, "data/phyloseq-objects")
path.plots <- file.path(path.root, "Analysis/Plots/Individual/LoPresti-2019")
```


## Read data
```{r read-data, echo=FALSE}
physeq <- readRDS(file.path(path.data, "physeq_lopresti.rds")) # phyloseq object
```

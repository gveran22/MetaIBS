...
- [data/](data/): `data` directory containing preprocessed data (phyloseq objects, count tables aggregated at different taxonomic levels, ASV sequences imputed from the raw fastq files). You will find there the data generated by Salomé Carcy, Johannes Ostner and Viet Tran, that you can use directly to extend this meta-analysis with your own datasets;
- [data_empty/](data_empty/): empty `data` directory for users who would like to reproduce our results. It copies the directory structure of the [data/](data/) directory, but only contains `README.md` files;
...
Make sure to change file paths in the scripts and export all of your outputs to the [data_empty/](data_empty/) directory!

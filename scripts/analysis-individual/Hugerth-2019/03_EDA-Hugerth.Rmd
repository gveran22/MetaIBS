---
title: "Hugerth2019_DataAnalysis"
output:
  html_document:
    df_print: paged
    toc: true
...
path.hugerth <- file.path(path.root, "data/preprocessing/analysis-individual/Hugerth-2019/03_EDA-Hugerth")

# Import phyloseq object
physeq.hugerth <- readRDS(file.path(path.root, "data/phyloseq-objects/physeq_hugerth.rds"))
...
physeq.rel    <- readRDS(file.path(path.hugerth, "physeq_relative.rds"))
physeq.clr    <- readRDS(file.path(path.hugerth, "physeq_clr.rds"))
physeq.CSN    <- readRDS(file.path(path.hugerth, "physeq_CSN.rds"))
physeq.NZcomp <- readRDS(file.path(path.hugerth, "physeq_NZcomp.rds"))
```
...
# ggsave(file.path(path.hugerth, "absAbundance_phylum.jpg"), width=20, height=7)
...
# ggsave(file.path(path.hugerth, "relAbundance_phylum.jpg"), width=12, height=7)
...
ggplot(class.table, aes(x = reorder(Sample, Sample, function(x) mean(class.table[Sample == x & Phylum == 'Bacteroidota', 'Abundance'])),
  ...
  labs(x = "Samples", y = "Relative abundance", title = "Hugerth dataset (2020)")
# ggsave(file.path(path.hugerth, "relAbundance_class.jpg"), width=12, height=57)
```



## 9.3. Firmicutes/Bacteroidota ratio
...
# ggsave(file.path(path.hugerth, "ratioFB.jpg"), width=4, height=6)
...
ggplot(ratio.FB, aes(x = sample_type, y = logRatioFB))+
  ...
  theme_cowplot()+
  theme(legend.position="none")
# ggsave(file.path(path.hugerth, "ratioFB_paired-data.jpg"), width=5, height=5)
...
# Save object
saveRDS(physeq.NZcomp, file.path(path.hugerth, "physeq_NZcomp.rds"))
...
saveRDS(physeq.rel, file.path(path.hugerth, "physeq_relative.rds"))
...
saveRDS(physeq.CSN, file.path(path.hugerth, "physeq_CSN.rds"))
...
# save the physeq.rel object
saveRDS(physeq.clr, file.path(path.hugerth, "physeq_clr.rds"))
```
...
# ggsave(file.path(path.hugerth, "distances4_MDS_stool.jpg"), height = 4, width = 15)
```
...
# ggsave(file.path(path.hugerth, "distances4_MDS_sigmoid.jpg"), height = 4, width = 15)
```
...
# ggsave(file.path(path.hugerth, "distances4_MDS_all.jpg"), height = 8, width = 15)
```

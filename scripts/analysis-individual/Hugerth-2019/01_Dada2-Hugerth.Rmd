...
physeq            <- readRDS(file.path(path.root, "data/analysis-individual/CLUSTER/phylotree/input/physeq_hugerth.rds")) # phyloseq object without phylogenetic tree
```
...
saveRDS(nb.reads, file.path(path.root, "data/analysis-combined/06_QCplot/nbreads_hugerth.rds"))
```
...
# saveRDS(seqtable.nochim, file.path(path.root, "data/analysis-individual/CLUSTER/taxonomy/input/seqtablenochim_hugerth.rds"))
...
# taxa <- readRDS(file.path(path.root, "data/analysis-individual/CLUSTER/taxonomy/output/taxa_hugerth.rds"))
```

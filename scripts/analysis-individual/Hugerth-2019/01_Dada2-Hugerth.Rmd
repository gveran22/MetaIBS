...
FWD.filt1_samples <- file.path(path.hugerth, "filtered1", paste0(sample.names, "_1_filt.fastq.gz")) # FWD reads
REV.filt1_samples <- file.path(path.hugerth, "filtered1", paste0(sample.names, "_2_filt.fastq.gz")) # REV reads
...
FWD.filt2_samples <- file.path(path.hugerth, "filtered2", paste0(sample.names, "_1_filt.fastq.gz")) # FWD reads
REV.filt2_samples <- file.path(path.hugerth, "filtered2", paste0(sample.names, "_2_filt.fastq.gz")) # REV reads
# Assign names for the filtered fastq.gz files

##########################
# Purpose: Add phylogenetic tree to Zeber phyloseq object
# Date: February 2023
# Author: Salomé Carcy
##########################
...
#____________________________________________________________________
# IMPORT DATA
physeq <- readRDS(file.path(path.root, "input/physeq_zeber.rds"))
...
taxa_names(physeq) <- paste0("ASV_zeber_", seq(ntaxa(physeq))) # replace the whole dna sequences in the taxa_names by a surname ASV_zeber_1, ASV_zeber_2, etc.

# Save physeq object
saveRDS(physeq, file.path(path.root, "output/physeq_zeber.rds"))

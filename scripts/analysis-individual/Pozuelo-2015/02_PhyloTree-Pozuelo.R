##########################
# Purpose: Add phylogenetic tree to Pozuelo phyloseq object
# Date: February 2023
# Author: Salomé Carcy
##########################
...
#____________________________________________________________________
# IMPORT DATA
physeq <- readRDS(file.path(path.root, "input/physeq_pozuelo.rds"))
...
taxa_names(physeq) <- paste0("ASV_pozuelo_", seq(ntaxa(physeq))) # replace the whole dna sequences in the taxa_names by a surname ASV_pozuelo_1, ASV_pozuelo_2, etc.

# Save physeq object
saveRDS(physeq, file.path(path.root, "output/physeq_pozuelo.rds"))

...
path.fukui <- file.path(path.root, "data/preprocessing/analysis-individual/Fukui-2020/03_EDA-Fukui")

# Import phyloseq object
physeq.fukui <- readRDS(file.path(path.root, "data/phyloseq-objects/physeq_fukui.rds"))

##########################
# Purpose: Add phylogenetic tree to Fukui phyloseq object
# Date: February 2023
# Author: Salomé Carcy
##########################
...
#____________________________________________________________________
# IMPORT DATA
physeq <- readRDS(file.path(path.root, "input/physeq_fukui.rds"))
...
taxa_names(physeq) <- paste0("ASV_fukui_", seq(ntaxa(physeq))) # replace the whole dna sequences in the taxa_names by a surname ASV_fukui_1, ASV_fukui_2, etc.

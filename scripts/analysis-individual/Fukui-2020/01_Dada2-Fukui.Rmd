...
FWD.filt2_samples <- file.path(path, "filtered_fastq", paste0(sample.names, "_1_filt.fastq.gz")) # FWD reads
REV.filt2_samples <- file.path(path, "filtered_fastq", paste0(sample.names, "_2_filt.fastq.gz")) # REV reads

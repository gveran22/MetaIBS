...
FWD.out1          <- readRDS(file.path(path.data, "01_Dada2-Fukui/FWD_out1.rds")) # out process (primerfilt-FWD)
REV.out1          <- readRDS(file.path(path.data, "01_Dada2-Fukui/REV_out1.rds")) # out process (primerfilt-REV)
out2              <- readRDS(file.path(path.data, "01_Dada2-Fukui/out2.rds")) # out process
FWD.filt1_samples <- sort(list.files(file.path(path.data, "filtered1"), pattern="_1_filt1.fastq.gz", full.names = TRUE)) # primer-trimmed reads (FWD)
REV.filt1_samples <- sort(list.files(file.path(path.data, "filtered1"), pattern="_2_filt1.fastq.gz", full.names = TRUE)) # primer-trimmed reads (REV)
FWD.filt2_samples <- sort(list.files(file.path(path.data, "filtered2"), pattern="_1_filt2.fastq.gz", full.names = TRUE)) # quality-filtered reads
REV.filt2_samples <- sort(list.files(file.path(path.data, "filtered2"), pattern="_2_filt2.fastq.gz", full.names = TRUE)) # quality-filtered reads
...
saveRDS(FWD.out1,  file.path(path.data, "01_Dada2-Fukui/FWD_out1.rds"))
saveRDS(REV.out1,  file.path(path.data, "01_Dada2-Fukui/REV_out1.rds"))

...
FWD.filt2_samples <- sort(list.files(file.path(path, "filtered_fastq"), pattern="_1_filt.fastq.gz", full.names = TRUE)) # quality profiles
REV.filt2_samples <- sort(list.files(file.path(path, "filtered_fastq"), pattern="_2_filt.fastq.gz", full.names = TRUE)) # quality profiles
...
FWD.filt2_samples <- file.path(path.fukui, "filtered_fastq", paste0(sample.names, "_1_filt.fastq.gz")) # FWD reads
REV.filt2_samples <- file.path(path.fukui, "filtered_fastq", paste0(sample.names, "_2_filt.fastq.gz")) # REV reads

...
physeq        <- readRDS(file.path(path.root, "data/analysis-individual/CLUSTER/PhyloTree/input/physeq_lopresti.rds")) # phyloseq object without phylogenetic tree
```
...
saveRDS(nb.reads, file.path(path.root, "data/analysis-combined/06_QCplot/nbreads_lopresti.rds")
```
...
# saveRDS(seqtable.nochim, file.path(path.root, "data/analysis-individual/CLUSTER/taxonomy/input/seqtablenochim_lopresti.rds"))
...
# taxa <- readRDS(file.path(path.root, "data/analysis-individual/CLUSTER/taxonomy/output/taxa_lopresti.rds"))
```
...
saveRDS(physeq, file.path(path.root, "data/analysis-individual/CLUSTER/PhyloTree/input/physeq_lopresti.rds"))
```

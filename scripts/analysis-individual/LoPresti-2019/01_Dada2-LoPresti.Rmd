...
path.lopresti <- file.path(path.root, "scripts/analysis-individual/LoPresti-2019")
path.data     <- file.path(path.root, "data/preprocessing/analysis-individual/LoPresti-2019")
```
...
raw_stats     <- readRDS(file.path(path.data, "01_Dada2-LoPresti/raw_stats.rds")) # seq depth
out1          <- readRDS(file.path(path.data, "01_Dada2-LoPresti/out1.rds")) # out process (primer removal)
out2          <- readRDS(file.path(path.data, "01_Dada2-LoPresti/out2.rds")) # out process (QC)
...
err           <- readRDS(file.path(path.data, "01_Dada2-LoPresti/err.rds")) # error rates
seq_infered   <- readRDS(file.path(path.data, "01_Dada2-LoPresti/seq_infered.rds")) # infered ASVs
taxa          <- readRDS(file.path(path.data, "01_Dada2-LoPresti/taxa_lopresti.rds")) # taxa
physeq        <- readRDS(file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/PhyloTree/input/physeq_lopresti.rds")) # phyloseq object without phylogenetic tree
```
...
path.fastq <- file.path(path.lopresti, "download-LoPresti-samples/")
...
saveRDS(nb.reads, file.path(path.root, "data/preprocessing/dada2-filt/nbreads_lopresti.rds")
```
...
# saveRDS(seqtable.nochim, file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/taxonomy/input/seqtablenochim_lopresti.rds"))
...
# taxa <- readRDS(file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/taxonomy/output/taxa_lopresti.rds"))
```
...
# Import metadata
metadata_table <- read.csv(file.path(path.lopresti, "00_Metadata-LoPresti/LoPrestiSraRunTable.csv"))
...
```{r save, eval=FALSE}
# Save to disk
saveRDS(raw_stats,   file.path(path.data, "01_Dada2-LoPresti/raw_stats.rds"))
saveRDS(out1,        file.path(path.data, "01_Dada2-LoPresti/out1.rds"))
saveRDS(out2,        file.path(path.data, "01_Dada2-LoPresti/out2.rds"))
saveRDS(err,         file.path(path.data, "01_Dada2-LoPresti/err.rds"))
saveRDS(seq_infered, file.path(path.data, "01_Dada2-LoPresti/seq_infered.rds"))

write.csv(sample_data(physeq), file.path(path.lopresti, "00_Metadata-LoPresti/Metadata-LoPresti.csv")) # metadata table

# Taxa & Phyloseq object
saveRDS(taxa,   file.path(path.data, "01_Dada2-LoPresti/taxa_lopresti.rds"))
saveRDS(physeq, file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/PhyloTree/input/physeq_lopresti.rds"))
```

##########################
# Purpose: Add phylogenetic tree to LoPresti phyloseq object
# Date: February 2023
# Author: Salomé Carcy
##########################
...
#____________________________________________________________________
# IMPORT DATA
physeq <- readRDS(file.path(path.root, "input/physeq_lopresti.rds"))
...
taxa_names(physeq) <- paste0("ASV_lopresti_", seq(ntaxa(physeq))) # replace the whole dna sequences in the taxa_names by a surname ASV_lopresti_1, ASV_lopresti_2, etc.

# Save physeq object
saveRDS(physeq, file.path(path.root, "output/physeq_lopresti.rds"))

...
path.data    <- file.path(path.root, "data/preprocessing/analysis-individual/Zhuang-2018")
```
...
raw_stats         <- readRDS(file.path(path.data, "01_Dada2-Zhuang/raw_stats.rds")) # seq depth
out2              <- readRDS(file.path(path.data, "01_Dada2-Zhuang/out2.rds")) # out process (QC)
FWD.filt2_samples <- file.path(path, "filtered2", paste0(sample.names, "_1_filt.fastq.gz")) # quality-filtered reads (FWD)
REV.filt2_samples <- file.path(path, "filtered2", paste0(sample.names, "_2_filt.fastq.gz")) # quality-filtered reads (REV)
errF              <- readRDS(file.path(path.data, "01_Dada2-Zhuang/errF.rds")) # error rates F
errR              <- readRDS(file.path(path.data, "01_Dada2-Zhuang/errR.rds")) # error rates R
dadaFs            <- readRDS(file.path(path.data, "01_Dada2-Zhuang/infered_seq_F.rds")) # inferred ASVs F
dadaRs            <- readRDS(file.path(path.data, "01_Dada2-Zhuang/infered_seq_R.rds")) # inferred ASVs R
mergers           <- readRDS(file.path(path.data, "01_Dada2-Zhuang/mergers.rds")) # mergers
taxa              <- readRDS(file.path(path.data, "01_Dada2_Zhuang/taxa_zhuang.rds")) # taxa
physeq            <- readRDS(file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/PhyloTree/input/physeq_zhuang.rds")) # phyloseq object without phylogenetic tree
```
...
path.fastq <- file.path(path.zhuang, "download-Zhuang-samples")
...
#          "dataset" = "AGP")
saveRDS(nb.reads, file.path(path.root, "data/preprocessing/dada2-filt/nbreads_zhuang.rds")
```
...
# saveRDS(seqtable.nochim, file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/taxonomy/input/seqtablenochim_zhuang.rds"))
...
# taxa <- readRDS(file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/taxonomy/output/taxa_zhuang.rds"))
```
...
# Import metadata
metadata_table <- read.csv(file.path(path.zhuang, "00_Metadata-Zhuang/Metadata-Zhuang.csv"))
...
saveRDS(taxa,   file.path(path.data, "taxa_zhuang.rds"))
saveRDS(physeq, file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/PhyloTree/input/physeq_zhuang.rds"))
```

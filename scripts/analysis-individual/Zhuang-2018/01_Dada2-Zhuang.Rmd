...
FWDpos            <- readRDS(file.path(path.data, "01_Dada2-Zhuang/forwardreads_primerposition.rds"))
REVpos            <- readRDS(file.path(path.data, "01_Dada2-Zhuang/reversereads_primerposition.rds"))
FWD.out1          <- readRDS(file.path(path.data, "01_Dada2-Zhuang/FWD_out1.rds")) # out process (primerfilt-FWD)
REV.out1          <- readRDS(file.path(path.data, "01_Dada2-Zhuang/REV_out1.rds")) # out process (primerfilt-REV)
...
taxa              <- readRDS(file.path(path.data, "01_Dada2-Zhuang/taxa_zhuang.rds")) # taxa

...
physeq            <- readRDS(file.path(path.root, "data/analysis-individual/CLUSTER/PhyloTree/input/physeq_zhuang.rds")) # phyloseq object without phylogenetic tree
```
...
#          "dataset" = "AGP")
saveRDS(nb.reads, file.path(path.root, "data/analysis-combined/06_QCplot/nbreads_zhuang.rds")
```
...
# saveRDS(seqtable.nochim, file.path(path.root, "data/analysis-individual/CLUSTER/taxonomy/input/seqtablenochim_zhuang.rds"))
...
# taxa <- readRDS(file.path(path.root, "data/analysis-individual/CLUSTER/taxonomy/output/taxa_zhuang.rds"))
```

##########################
# Purpose: Add phylogenetic tree to Ringel phyloseq object
# Date: February 2023
# Author: Salomé Carcy
##########################
...
#____________________________________________________________________
# IMPORT DATA
physeq <- readRDS(file.path(path.root, "input/physeq_ringel.rds"))
...
taxa_names(physeq) <- paste0("ASV_ringel_", seq(ntaxa(physeq))) # replace the whole dna sequences in the taxa_names by a surname ASV_ringel_1, ASV_ringel_2, etc.

# Save physeq object
saveRDS(physeq, file.path(path.root, "output/physeq_ringel.rds"))

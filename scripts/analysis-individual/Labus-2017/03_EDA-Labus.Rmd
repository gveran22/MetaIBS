...
path.labus <- file.path(path.root, "data/preprocessing/analysis-individual/Labus-2017/03_EDA-Labus")

# Import phyloseq object
physeq.labus <- readRDS(file.path(path.root, "data/phyloseq-objects/physeq_labus.rds"))
...
physeq.rel    <- readRDS(file.path(path.labus, "03_EDA-Labus/physeq_relative.rds"))
physeq.clr    <- readRDS(file.path(path.labus, "03_EDA-Labus/physeq_clr.rds"))
physeq.CSN    <- readRDS(file.path(path.labus, "03_EDA-Labus/physeq_CSN.rds"))
physeq.NZcomp <- readRDS(file.path(path.labus, "03_EDA-Labus/physeq_NZcomp.rds"))
```
...
plot_bar(physeq.labus, fill = "Phylum") + facet_wrap("host_disease", scales="free") +
  ...
  ylim(0,7000)
# ggsave(file.path(path.labus, "absAbundance_phylum.jpg"), width=13, height=5)
...
# ggsave(file.path(path.labus, "relAbundance_phylum.jpg"), width=10, height=5)
...
ggplot(class.table, aes(x = reorder(Sample, Sample, function(x) mean(class.table[Sample == x & Phylum == 'Firmicutes', 'Abundance'])),
  ...
  theme(axis.text.x = element_text(size = 6, angle = -90))+
  labs(x = "Samples", y = "Relative abundance", title = "Labus dataset (2017)")
# ggsave(file.path(path.labus, "relAbundance_class.jpg"), width=12, height=5)
```
...
# ggsave(file.path(path.labus, "ratioFB.jpg"), width=4, height=6)
...
# ggsave(file.path(path.labus, "ratioFB_subtype.jpg"), width=5, height=7)
...
# Save object
saveRDS(physeq.NZcomp, file.path(path.labus, "03_EDA-Labus/physeq_NZcomp.rds"))
...
saveRDS(physeq.rel, file.path(path.labus, "03_EDA-Labus/physeq_relative.rds"))
...
saveRDS(physeq.CSN, file.path(path.labus, "03_EDA-Labus/physeq_CSN.rds"))
...
# save the physeq.rel object
saveRDS(physeq.clr, file.path(path.labus, "03_EDA-Labus/physeq_clr.rds"))
```
...
# ggsave(file.path(path.labus, "distances4_MDS.jpg"), height = 4, width = 15)
```

...
physeq.rel    <- readRDS(file.path(path.labus, "physeq_relative.rds"))
physeq.clr    <- readRDS(file.path(path.labus, "physeq_clr.rds"))
physeq.CSN    <- readRDS(file.path(path.labus, "physeq_CSN.rds"))
physeq.NZcomp <- readRDS(file.path(path.labus, "physeq_NZcomp.rds"))
```
...
# Save object
saveRDS(physeq.NZcomp, file.path(path.labus, "physeq_NZcomp.rds"))
...
saveRDS(physeq.rel, file.path(path.labus, "physeq_relative.rds"))
...
saveRDS(physeq.CSN, file.path(path.labus, "physeq_CSN.rds"))
...
# save the physeq.rel object
saveRDS(physeq.clr, file.path(path.labus, "physeq_clr.rds"))
```

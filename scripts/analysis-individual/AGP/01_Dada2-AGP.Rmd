...
filt2_samples <- sort(list.files(file.path(path.data, "filtered_fastq"), pattern=".fastq.gz", full.names = TRUE)) # quality-filtered reads
...
# saveRDS(seqtable.nochim, file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/taxonomy/input/seqtablenochim_agp.rds"))
...
# taxa <- readRDS(file.path(path.root, "data/preprocessing/analysis-individual/CLUSTER/taxonomy/output/taxa_agp.rds"))
```

...
#____________ THIS IS ONLY FOR (quicker) HTML OUTPUT __________________
#_____________________________________________________________________
path <- "~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/AGP"

# seq depth
raw_stats <- readRDS("~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/AGP/01_Dada2-AGP/raw_stats.rds")
# out process
out2 <- readRDS("~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/AGP/01_Dada2-AGP/out2.rds")
# quality profiles
filt2_samples <- sort(list.files(file.path(path, "filtered2"), pattern=".fastq.gz", full.names = TRUE))
# error rates
err <- readRDS("~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/AGP/01_Dada2-AGP/err.rds")
# infered ASVs
seq_infered <- readRDS("~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/AGP/01_Dada2-AGP/seq_infered.rds")
# taxa
taxa <- readRDS("~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/CLUSTER/Taxonomy/output/taxa_agp.rds")
# phyloseq object
physeq <- readRDS("~/Projects/IBS_Meta-analysis_16S/data_local/analysis-individual/AGP/01_Dada2-AGP/physeq_agp_with_bloom.rds")
```
...
saveRDS(nb.reads, "~/Projects/IBS_Meta-analysis_16S/data/dada2-filt/seqdepth_agp.rds")
```
...
taxa <- assignTaxonomy(seqtable.nochim, "~/Projects/IBS_Meta-analysis_16S/data_local/silva_nr_v138_train_set.fa.gz",
                       tryRC = TRUE, # try reverse complement of the sequences
                       multithread=TRUE, verbose = TRUE)

# Add species assignment
taxa <- addSpecies(taxa, "~/Projects/IBS_Meta-analysis_16S/data_local/silva_species_assignment_v138.fa.gz")
```
...
# SAVE FINAL DATA
# saveRDS(otu_table(physeq.filt), file.path(path, "01_Dada2-AGP/ASVtable_final.rds")) # ASV table
# saveRDS(tax_table(physeq.filt), file.path(path, "01_Dada2-AGP/taxa_final.rds")) # taxa table
# saveRDS(sample_data(physeq.filt), file.path(path, "01_Dada2-AGP/metadata_final.rds")) # metadata table

# Taxa & Phyloseq object
# saveRDS(physeq.filt, "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/PhyloTree/input/physeq_agp.rds")
```

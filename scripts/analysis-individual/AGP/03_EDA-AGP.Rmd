...
# ggsave(file.path(path.plots, "absAbundance_phylum.jpg"), width=13, height=7)
```
...
ggplot(class.table, aes(x = reorder(Sample, Sample, function(x) mean(phylum.table[Sample == x & Phylum == 'Firmicutes', 'Abundance'])),
  ...
  labs(x = "Samples", y = "Relative abundance", title = "AGP dataset")
# ggsave(file.path(path.plots, "relAbundance_class.jpg"), width=15, height=5)
```
...
# saveRDS(dist.agp, file.path(path, "data/analysis-individual/AGP/02_EDA-AGP/distances.rds"))
# saveRDS(plot.df, file.path(path, "data/analysis-individual/AGP/02_EDA-AGP/plot_distances.rds"))
```

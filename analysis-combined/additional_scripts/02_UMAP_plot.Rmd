...
# path <- "~/Projects/IBS_Meta-analysis_16S/data/analysis-combined/02_UMAP/data_logratio_all/"
...
```{r plot-phylum, fig.width=9, fig.height=7}
# GET UMAP DF
...
```{r plot-class, fig.width=9, fig.height=7}
# GET UMAP DF
umap.df <- NULL
...
```{r plot-order, fig.width=9, fig.height=7}
# GET UMAP DF
umap.df <- NULL
...
```{r plot-family, fig.width=9, fig.height=7}
# GET UMAP DF
umap.df <- NULL

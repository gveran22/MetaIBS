...
```{r}
# IMPORT DATA
path <- "~/Projects/IBS_Meta-analysis_16S/data/analysis-individual/CLUSTER/UMAP/data_clr"
...
# Plot ggplot
ggplot(dims.umapGenus, aes(x = UMAP_1, y = UMAP_2, color = author))+
  geom_point(size = 1, alpha = 0.8)+
  scale_color_manual(values=brewer.paired(n=13), name="")+
  theme(panel.grid = element_blank(),
        panel.background=element_blank())
# ggsave("~/Projects/IBS_Meta-analysis_16S/data/analysis-combined/02_UMAP/umapGenus_author.jpg", width=6, height=3.5)
